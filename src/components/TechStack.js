        ...
        <div className="main_tech">
          ...
          <div className="frontend">
            ...
            <div>
              ...
              <img
                className="fni"
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Logo_material_design.svg/2560px-Logo_material_design.svg.png"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="main_tech">
          ...
          <div className="backend">
            ...
            <div>
              ...
              <img
                className="fni"
                src="https://www.svgrepo.com/show/13344/sql-file-format.svg"
                alt=""
              />
            </div>
          </div>
